...
function Person(e, p) {
    ...
    // TODO: Venat CN name
    var trustList = [
        "阿尔菲诺", "Alphinaud", "アルフィノ",
        "阿莉塞", "Alisaie", "アリゼー",
        "水晶公", "Crystal Exarch", "水晶公",
        "爱梅特赛尔克", "Emet-Selch", "エメトセルク",
        "埃斯蒂尼安", "Estinien", "サンクレッド",
        "希斯拉德", "Hythlodaeus", "ヒュトロダエウス",
        "古·拉哈·提亚", "G'raha Tia", "グ・ラハ・ティア",
        "莱楠", "Lyna", "ライナ",
        "敏菲利亚", "Minfilia", "ミンフィリア",
        "琳", "Ryne", "リーン",
        "桑克瑞德", "Thancred", "サンクレッド",
        "于里昂热", "Urianger", "ウリエンジェ",
        "Venat", "ヴェーネス",
        "雅·修特拉", "Y'shtola", "ヤ・シュトラ"
    ]
    var trustName = this.name.split(' (')[0];
    if (trustList.indexOf(trustName) > -1) {
        this.name = trustName
    }
