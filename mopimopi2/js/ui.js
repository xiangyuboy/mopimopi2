...
$('nav[name=main] .btn_wrap').on({
    mouseleave: function() {
        ...
        var arr = ['Capture', 'RequestEnd', 'History', "YOU"]
        for (var i in arr) {
    ...
    switch (id) {
        ...
        case 'YOU':
            if(isYOU){
                ...
                isYOU = true;
                $(".tableWrap:not(:contains('YOU'))").hide();
            }
            if(lastCombat != undefined && lastCombat != null){
                update(lastCombat, lastCombat);
            }
            break
        case 'YOUCHANGE':
            if(!isYOU){
...
function createDOM(type, obj, id) {
    ...
    switch (type) {
        case 'preview':
            if (init.q.preview == 1) {
                $('.previewArea').html('<div><nav name="main"><table name="ACT_2line"><tr><td rowspan="2" name="time">00:00</td><td name="target"></td></tr><tr><td name="rps"></td></tr></table><table name="ACT_1line" style="display:none;"><tr><td name="time">00:00</td><td name="target"></td><td name="rps"></td></tr></table><div class="right btn_wrap" style="top:0"><div name="Capture" class="btn flex" style="display: none"><i class="material-icons">camera</i></div><div name="History" class="btn flex" style="display: none" ><i class="material-icons">history</i></div><div name="RequestEnd" class="btn flex" style="display: none" ><i class="material-icons">timer_off</i></div><div name="YOU" class="btn flex" style="display: none" onclick="button("YOU")"><i class="material-icons">accessibility_new</i></div><div name="More" class="btn flex"><input type="checkbox" /><i class="material-icons">more_vert</i></div></div></nav><div name="main_P"></div> <table id="preview24"><tr><td style="color:rgba(189,189,189,.5); font-size:1.2rem">' + l.raid.tab_general.inner.view24_Number.tt[lang] + '</td><td><div class="switch"><div class="toggle"></div></div><input type="checkbox"/></td></tr></table></div>')
                update(previewDPS, previewHPS)
            }
            break
        case 'dr_nav':
...
function ui() {
    ...
    var icon = ['Capture', 'RequestEnd', 'History', "YOU"]
    for (var i in icon) {
