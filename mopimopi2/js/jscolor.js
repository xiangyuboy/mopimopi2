        ...
        var jsc = {
            ...
            attachEvent: function(el, evnt, func) {
                if (el.addEventListener) {
                    el.addEventListener(evnt, func, !1)
            ...
            detachEvent: function(el, evnt, func) {
                if (el.removeEventListener) {
                    el.removeEventListener(evnt, func, !1)
            ...
            attachDOMReadyEvent: function(func) {
                ...
                if (document.addEventListener) {
                    document.addEventListener('DOMContentLoaded', fireOnce, !1);
                    window.addEventListener('load', fireOnce, !1)
            ...
            redrawPosition: function() {
                if (jsc.picker && jsc.picker.owner) {
                    ...
                    var tp, vp;
                    if (thisObj.fixed) {
                        tp = jsc.getElementPos(thisObj.targetElement, !0);
                        vp = [0, 0]
                    } else {
            ...
            jscolor: function(targetElement, options) {
                ...
                function drawPicker() {
                    ...
                    if (jsc.isElementType(container, 'body')) {
                        ...
                        jsc._drawPosition(THIS, 0, 0, 'relative', !1)
                    }
