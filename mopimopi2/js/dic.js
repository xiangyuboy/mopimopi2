d = {
    ...
    caution_m1: {
        ...
        CN: '<br>取消勾选<br>ACT ❯ Plugins ❯ ACTWebSocket ❯ Open Manager ❯ Preferences ❯ <font class="ac"><b>No Focus</b> 以直接输入字符。</font>',
    },
    caution_m2: {
        ...
        CN: '<br>取消勾选<br>ACT ❯ Plugins ❯ ACTWebSocket ❯ Open Manager ❯ Preferences ❯ <font class="ac"><b>No Focus</b> 以直接输入字符。</font><br><br><font class="ac">❖ 移动端不支持此功能。<br>❖ 您只能输入字体名称。 (除字体样式外)<br>❖ 如果字体文损坏或者不存在，则使用默认字体。</font>',
    },
    input_font: {
        m: {
            KR: "글꼴 이름",
    ...
    itYOU: {
        ...
        CN: "图标，文字<font class='ex'>　❙ 个人角色</font>"
    },
    itOther: {
