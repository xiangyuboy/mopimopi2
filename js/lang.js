...
l = {
    Notice: {
        strong: {
            KR: '<b style="color:#ffea00">모피모피<br>놀라운 커스터마이징을 경험하세요!</b><br><br>모바일 환경에서는 <b>크롬 또는 사파리</b> 앱을 권장합니다.<br>PC 유저는 <b>오버레이 프로세스 관리자 ❯ 드래그 영역 사용 체크</b> 필수입니다.<br><br><font style="color:cyan">FFXIV_ACT_Plugin.dll 2.0.2.3 버전 이상을 사용하는 유저는<br>ACT → Plugins → FFXIV Settings Tab → <b>Disable Combine Pets with Owner</b> 옵션을 체크합니다.</font><br><br>Please select <b>your language</b> : <a href="#" id="KR" onclick="initOverlay(this.id)">한국어</a> ❘ <a href="#" id="EN" onclick="initOverlay(this.id)">English</a> ❘ <a href="#" id="JP" onclick="initOverlay(this.id)">日本語</a> ❘ <a href="#" id="CN" onclick="initOverlay(this.id)">简体中文</a> ❘ <a href="#" id="DE" onclick="initOverlay(this.id)">Deutsch</a> ❘ <a href="#" id="FR" onclick="initOverlay(this.id)">French</a><br>',
            EN: '<b style="color:#ffea00">MopiMopi<br>Experience the Incredible Customizing!</b><br><br><b>Chrome or Safari</b> apps are recommended for mobile environment.<br>PC Users : <b>OverlayProc ❯ MUST Check "AppRegion"</b> to limit the draggable area.<br><br><font style="color:cyan">If you are using FFXIV_ACT_Plugin version 2.0.2.3 or later,<br>ACT → Plugins → FFXIV Settings Tab → <b>Check Disable Combine Pets with Owner</b>.</font><br><br>Please select <b>your language</b> : <a href="#" id="KR" onclick="initOverlay(this.id)">한국어</a> ❘ <a href="#" id="EN" onclick="initOverlay(this.id)">English</a> ❘ <a href="#" id="JP" onclick="initOverlay(this.id)">日本語</a> ❘ <a href="#" id="CN" onclick="initOverlay(this.id)">简体中文</a> ❘ <a href="#" id="DE" onclick="initOverlay(this.id)">Deutsch</a> ❘ <a href="#" id="FR" onclick="initOverlay(this.id)">French</a><br>',
            CN: '<b style="color:#ffea00">MopiMopi<br>享受无与伦比的客制化！</b><br><br>尝试一下我们预配置好的主题：<a href="#" id="ClearSky" onclick="ChangeTheme(this.id)">碧空</a><br><br>移动设备和直播(OBS Studio, XSplit等)用户<br>需要安装<a href="https://github.com/ZCube/ACTWebSocket/releases" target="_blank">ACTWebsocket 1.3.3.9或更高</a>版本。<br><br>移动设备环境下推荐使用<b>Chrome&Safari</b>应用。<br>PC用户：务必勾选<b>OverlayProc ❯ "AppRegion"</b>以限制拖放区域。<br><br>您可以切换<b>界面语言</b> : <a href="#" id="KR" onclick="initOverlay(this.id)">한국어</a> ❘ <a href="#" id="JP" onclick="initOverlay(this.id)">日本語</a> ❘ <a href="#" id="CN" onclick="initOverlay(this.id)">简体中文</a> ❘ <a href="#" id="EN" onclick="initOverlay(this.id)">English</a> ❘ <a href="#" id="DE" onclick="initOverlay(this.id)">Deutsch</a><br>'
        },
        tip: {
            KR: '[MIRANQUIL & DieMoe 220105] MopiMopi ver.20220102 / 해루@모그리',
        ...
        update: {
            ...
            EN: '<div name="row"><div class="b">01/02</div><div class="m">Fixed the hex code input bug</div></div><div name="row"><div class="u">12/28</div><div class="m">[Oh Miru@Anima/Mana] Added data of new action (SGE)</div></div><div name="row"><div class="c">12/20</div><div class="m">[绿叶小踢腿@豆豆柴/银泪湖] Adjusted name format of Trust comrades</div></div><div name="row"><div class="c">12/19</div><div class="m">[Fairy Selene@Asura/Mana] WHM data modified</div></div><div name="row"><div class="u">12/13</div><div class="m">[Oh Miru@Anima/Mana] Added 6.0 Carbuncle</div></div><div name="row"><div class="c">12/12</div><div class="m">[Oh Miru@Anima/Mana] Changed Limit Break data</div></div><div name="row"><div class="u">12/09</div><div class="m">[Oh Miru@Anima/Mana] Added data of new pets (SMN)</div></div><div name="row"><div class="u">12/03</div><div class="m">[Oh Miru@Anima/Mana] Added icon of new jobs (RPR/SGE)</div></div><div name="row"><div class="b">12/03</div><div class="m">Please report 6.0 pets or actions name. <a href="https://docs.google.com/spreadsheets/d/1Cqni0rjvQLnXjK2dhx95xk_NOIIWXt9PK8-2gez5pTI/edit#gid=0" target="_blank">▶▶▶ Report link</a></div></div><div name="row"><div class="u">11/30</div><div class="m">Added data of new jobs (RPR/SGE)</div></div><div name="row"><div class="c">04/01</div><div class="m">[Matthew Smith/Gmail] Change Abbreviations<Br>(RD → Total DPS, RH → Total HPS, MD → My DPS, MH → My HPS)</div></div><div name="row"><div class="n">01/01</div><div class="m">★★★ 2021 Best wishes for a Happy New Year! ★★★</div></div>',
            CN: '<div name="row"><div class="b">01/02</div><div class="m">修复十六进制输入bug</div></div><div name="row"><div class="u">12/28</div><div class="m">[Oh Miru@Anima/Mana] 补充贤者新技能数据</div></div><div name="row"><div class="c">12/20</div><div class="m">[绿叶小踢腿@豆豆柴/银泪湖] 调整亲信战友姓名格式</div></div><div name="row"><div class="c">12/19</div><div class="m">[Fairy Selene@Asura/Mana] 调整白魔法师数据</div></div><div name="row"><div class="u">12/13</div><div class="m">[오미루@모그리] 新增6.0宝石兽</div></div><div name="row"><div class="c">12/12</div><div class="m">[Oh Miru@Mana/Anima] 改正极限技数据</div></div><div name="row"><div class="u">12/09</div><div class="m">[Oh Miru@Mana/Anima] 增加新召唤物数据 (SMN)</div></div><div name="row"><div class="u">12/03</div><div class="m">[Oh Miru@Mana/Anima] 增加新职业图标（钐镰/贤者）</div></div><div name="row"><div class="b">12/03</div><div class="m">请向我回报6.0的技能和宠物名（原作者或我都可以）。<a href="https://docs.google.com/spreadsheets/d/1Cqni0rjvQLnXjK2dhx95xk_NOIIWXt9PK8-2gez5pTI/edit#gid=0" target="_blank">▶▶▶ 回报链接</a></div></div><div name="row"><div class="u">11/30</div><div class="m">添加新职业数据（图标会很快上传）</div></div><div name="row"><div class="c">04/01</div><div class="m">[Matthew Smith/Gmail] 更改缩写<Br>(RD → Total DPS, RH → Total HPS, MD → My DPS, MH → My HPS)</div></div><div name="row"><div class="n">01/01</div><div class="m">★★★ 2021 祝大家新年快乐！ ★★★</div></div>'
        }
    },
    msg: {
        comma: {
        ...
        initConfirm: {
            m: {
                ...
                CN: "所有变更都会恢复到默认值，您的个人数据会被删除。要继续初始化吗？",
            }
        },
        init: {
            m: {
            ...
            dr: {
                ...
                keyboard: {
                    tt: {
                        ...
                        CN: "键盘锁定<font class='ex'> ❙ 移动设备</font>",
                    },
                    e: "dr_checkbox"
                },
                fullscreen: {
    ...
    Settings: {
        Lang: {
            ...
            m: {
                ...
                CN: {
                    KR: "简体中文<font class='ex'> ❙ by 豆豆柴 [银泪湖] 绿叶小踢腿</font>",
                    JP: "简体中文<font class='ex'> ❙ by 豆豆柴 [银泪湖] 绿叶小踢腿</font>",
                    EN: "简体中文<font class='ex'> ❙ by 豆豆柴 [银泪湖] 绿叶小踢腿</font>",
                    DE: "简体中文<font class='ex'> ❙ by 豆豆柴 [银泪湖] 绿叶小踢腿</font>",
                    CN: "简体中文<font class='ex'> ❙ by 豆豆柴 [银泪湖] 绿叶小踢腿</font>",
                },
                DE: {
    ...
    font: {
        ...
        fRPS: {
            tt: {
                ...
                CN: "数据<font class='ex'> ❙ 默认值 ❯ Georgia</font>",
            },
            e: 'li_pn',
            ul: 1
        },
            ...
            inner: {
                ...
                tableBorderYOU: {
                    tt: {
                        ...
                        CN: "文本边框<font class='ex'> ❙ 个人角色</font>",
                    },
                    i: "border_color",
                    e: "li_color",
                    ul: 0
                ...
                tableBorderOther: {
                    tt: {
                        ...
                        CN: "文本边框<font class='ex'> ❙ 其他角色</font>",
                    },
                    i: "border_color",
                    e: "li_color",
                    ul: 0
            ...
            inner: {
                ...
                tableYOU: {
                    tt: {
                        ...
                        CN: "图标、文本<font class='ex'> ❙ 个人角色</font>",
                    },
                    min: 0,
                    max: 100,
                    i: "opacity",
                ...
                tableOther: {
                    tt: {
                        ...
                        CN: "图标、文本<font class='ex'> ❙ 其他角色</font>",
                    },
                    min: 0,
                    max: 100,
                    i: "opacity",
            ...
            inner: {
                sizeHd: {
                    tt: {
                        ...
                        CN: "表头<font class='ex'> ❙ 表头 >= 表头文本</font>",
                    },
                    min: 0,
                    max: 50,
                    i: "swap_vert",
            ...
            inner: {
                ...
                act_max: {
                    tt: {
                        ...
                        CN: "MaxHit，MaxHeal<font class='ex'> ❙ 个人角色</font>",
                    },
                    e: "li_checkbox",
                    i: "looks_6",
                    ul: 0
